...
// Listen for client close event to clear status
if (window.launcher?.onClientClosed) {
    window.launcher.onClientClosed(() => {
        setMainStatus('', false);
        console.log('[Renderer] Client closed, status cleared');
    });
}
